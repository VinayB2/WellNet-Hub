    ...
    <>
      ...
      <>
        <div className="address-cart-card">
          ...
          <div>
            <div>
              Address<span className="ml-2 mr-2">:</span>
              <span className="text-danger">Vidya Nagar</span>
            </div>
            <div>
              Ph No<span className="ml-2 mr-2">:</span>
              <span className="text-danger">9483908348</span>
            </div>
            {/* <div>
